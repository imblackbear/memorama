...
const Cards = [[1,
   {
    id:1,  
    source: "https://i.imgur.com/q6U4JCg.png"
  }],[2,

  {
    id:2,             source:"https://i.imgur.com/s9xgvqn.png",
  }],[3,
  
  {
    id:3,   
 source:"https://i.imgur.com/GnZlsSO.png",
  }],[4,
  
  {
    id:4,      source:"https://i.imgur.com/DneSYuE.png",
  }],[5,
  
  {
    id:5,      source:"https://i.imgur.com/Ugxg9hR.png",
  }], [6,
  
  {
    id:6,      source:"https://i.imgur.com/GyYurEK.png",
  }  ]
]
...
class Card {
  ...
  renderCard(id) {
    const src = "https://i.imgur.com/CI9nbxC.png"
...
function endGame(resultGame, score){  
  document.getElementById('result-msg').innerHTML = " Gracias por participar";  
  result.classList.toggle("land-hide");  
}
